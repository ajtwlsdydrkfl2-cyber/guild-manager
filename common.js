...
const DEFAULT_BOSSES = [
  {name:'가레스',pts:1,records:['영혼','메이스'],spawn:{type:'regen',hours:24}},
  ...
  {name:'라르바',pts:1,records:['영혼','정수'],spawn:{type:'regen',hours:26}},
  {name:'라카제스',pts:2,records:['영혼','척추'],spawn:{type:'fixed',days:[0,1,2,3,4,5,6],hour:23,min:0}},
  {name:'레이디달리아',pts:1,records:['심장','투구'],spawn:{type:'regen',hours:15}},
  {name:'로데릭',pts:2,records:['영혼','갑옷'],spawn:{type:'fixed',days:[3],hour:19,min:30}},
  {name:'루쿠스',pts:3,records:['루쿠스의 핵','루쿠스의 오른팔','루쿠스의 왼팔'],spawn:{type:'fixed',days:[0],hour:19,min:0}},
  {name:'링고르',pts:2,records:['심장','발톱'],spawn:{type:'fixed',days:[6],hour:16,min:0}},
  {name:'리베라',pts:1,records:['심장','펜던트'],spawn:{type:'regen',hours:18}},
  {name:'리비티나',pts:2,records:['심장','날개'],spawn:{type:'fixed',days:[2,6],hour:21,min:30}},
  {name:'메투스',pts:1,records:['영혼','마갑'],spawn:{type:'regen',hours:36}},
  {name:'모티',pts:3,records:['얼음 조각','천 조각'],spawn:{type:'fixed',days:[6],hour:21,min:0}},
  ...
  {name:'비오렌트',pts:1,records:['심장','지느러미'],spawn:{type:'regen',hours:4}},
  ...
  {name:'세크레타',pts:1,records:['심장','뿔'],spawn:{type:'regen',hours:46}},
  {name:'수포르',pts:1,records:['심장','지팡이'],spawn:{type:'regen',hours:46}},
  {name:'슈라이어',pts:1,records:['심장','장갑'],spawn:{type:'regen',hours:26}},
  {name:'아라네오',pts:1,records:['심장','독샘'],spawn:{type:'regen',hours:18}},
  {name:'아멘티스',pts:1,records:['심장','발'],spawn:{type:'regen',hours:22}},
  {name:'아스타',pts:1,records:['심장','벨트'],spawn:{type:'regen',hours:46}},
  {name:'아우라크',pts:2,records:['심장','세포'],spawn:{type:'fixed',days:[4,5],hour:19,min:30}},
  {name:'알시',pts:3,records:['얼음 조각','천 조각'],spawn:{type:'fixed',days:[4],hour:22,min:30}},
  {name:'에고',pts:1,records:['심장','꼬리'],spawn:{type:'regen',hours:16}},
  {name:'언두미엘',pts:1,records:['심장','쇠사슬'],spawn:{type:'regen',hours:18}},
  {name:'오르도',pts:1,records:['심장','투구'],spawn:{type:'regen',hours:46}},
  {name:'와니타스',pts:1,records:['영혼','검자루'],spawn:{type:'regen',hours:36}},
  {name:'익시온',pts:3,records:['뿔','검파편'],spawn:{type:'fixed',days:[3],hour:22,min:30}},
  {name:'이카루시아',pts:3,records:['얼음 조각','천 조각'],spawn:{type:'fixed',days:[5],hour:22,min:0}},
  {name:'자르하갈',pts:3,records:['심장','파편'],spawn:{type:'fixed',days:[0],hour:20,min:0}},
  ...
  {name:'카테나',pts:1,records:['영혼','파편'],spawn:{type:'regen',hours:26}},
  ...
  {name:'티토르',pts:1,records:['심장','외피'],spawn:{type:'regen',hours:28}},
  {name:'포가르',pts:3,records:['심장','세포'],spawn:{type:'fixed',days:[5],hour:21,min:30}},
  {name:'헬레나',pts:2,records:['심장','날개'],spawn:{type:'fixed',days:[6],hour:23,min:0}},
  {name:'베나투스',pts:1,records:['심장','독샘'],spawn:{type:'regen',hours:4}},
];
