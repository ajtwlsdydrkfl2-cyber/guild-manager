...
const DEFAULT_BOSSES = [
  {name:'ㄱ오프런ㄱ',pts:25,records:['오프런'],spawn:null},
  {name:'길드보스1회',pts:4,records:['보스 토큰'],spawn:null},
  {name:'길드보스2회',pts:4,records:['보스 토큰'],spawn:null},
  ...
  {name:'슈라이어',pts:1.2,records:['심장','장갑'],spawn:{type:'regen',hours:26}},
  {name:'아라네오',pts:1,records:['심장','독샘'],spawn:{type:'regen',hours:18}},
  {name:'아멘티스',pts:1,records:['심장','발'],spawn:{type:'regen',hours:22}},
  {name:'아스타',pts:1.5,records:['심장','벨트'],spawn:{type:'regen',hours:46}},
  ...
  {name:'오르도',pts:1.5,records:['심장','투구'],spawn:{type:'regen',hours:46}},
